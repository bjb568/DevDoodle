...
function commentToString(comment, user) {
	...
	return (
		...
		(
			...
			(
				'<span class="sctrls">' +
				'<span ' + (voted ? 'class="clkd" title="Unvote"' : 'title="This comment is useful."') + '><svg class="up" width="18" height="20" xmlns="http://www.w3.org/2000/svg"><polygon points="7,-1 0,11 5,11 5,16 9,16 9,11 14,11" /></svg></span>' +
