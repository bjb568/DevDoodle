...
function applyProgramIframes() {
	...
	while (i--) {
		...
		var outputBlob = new Blob([
			'<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml"><head><title>Output frame</title></head><body>' + e[i].dataset.html + '<style>html{zoom:0.5}' + html(e[i].dataset.css) + '</style><script>alert=prompt=confirm=null;' + html(e[i].dataset.js) + '</script></body></html>'
